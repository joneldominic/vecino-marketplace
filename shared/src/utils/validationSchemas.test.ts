import { loginSchema, signupSchema, UserSchema } from './validationSchemas';
...
describe('Validation Schemas', () => {
  ...
  describe('signupSchema', () => {
    ...
    it('should require password confirmation if provided', () => {
      ...
      const validResult = signupSchema.safeParse(validWithConfirmation);
      ...
      const invalidResult = signupSchema.safeParse(invalidWithConfirmation);
